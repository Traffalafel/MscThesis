...
{
    internal class RunsComposite : TestComposite
    {
        ...
        public RunsComposite(Func<ITest> generate, int numRuns, int maxParallel, bool saveSeries, VariableSpecification varSpec) 
