...
{
    public class PerturbedTSP : FitnessFunction<Tour>
    {
        private readonly TspLib95Item _item;

        public PerturbedTSP(TspLib95Item item, double stdDeviation) : base(item.Problem.NodeProvider.CountNodes()) // problem size irrelevant
        {
            _item = item;
        }
